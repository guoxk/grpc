...
const (
	User_QueryUser_FullMethodName  = "/User/QueryUser"
...
type UserClient interface {
	...
	UpdateUser(ctx context.Context, in *QueryUserRequest, opts ...grpc.CallOption) (*QueryUserResponse, error)
}
...
func (c *userClient) UpdateUser(ctx context.Context, in *QueryUserRequest, opts ...grpc.CallOption) (*QueryUserResponse, error) {
	out := new(QueryUserResponse)
...
type UserServer interface {
	...
	UpdateUser(context.Context, *QueryUserRequest) (*QueryUserResponse, error)
...
func (UnimplementedUserServer) UpdateUser(context.Context, *QueryUserRequest) (*QueryUserResponse, error) {
...
func _User_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdateUser(ctx, req.(*QueryUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
